...
describe('Time Out Button Tests', function () {
    ...
    afterEach(async function () {
        ...
        await fs.writeFile('coverage-frontend/coveragetimeout'+ counter++ + '.json',
